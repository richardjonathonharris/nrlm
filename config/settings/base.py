"""
Base settings for nrlm project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (nrlm/config/settings/base.py - 3 = nrlm/)
APPS_DIR = ROOT_DIR.path('nrlm')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'nrlm.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Richard Harris""", 'richard.jonathon.harris@gmail.com'),
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///nrlm'),
}
